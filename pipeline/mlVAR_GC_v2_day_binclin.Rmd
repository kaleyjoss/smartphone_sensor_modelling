...
df = df[df$bin_clin2 != 3, ] # drop 3, because 3 = missing (originally people were set to 2 if they had missing scores.)
table(df$bin_clin2)
```
...
saveRDS(l_outlist, file=file.path(brighten_dir, paste0("mnet_output_binclin_g1g2",name,".RDS")))
